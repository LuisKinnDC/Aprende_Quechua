...
class EjerciciosIntermediosFragment : Fragment() {
    ...
    private fun finalizarLeccion(leccionId: String) {
        val leccionRef = db.collection("lecciones_intermedio")
        ...
        leccionRef.document(leccionId)
            ...
            .addOnSuccessListener {
                ...
                if (siguienteId != null) {
                    ...
                    Toast.makeText(requireContext(), "¡Has completado todas las lecciones intermedias!", Toast.LENGTH_LONG).show()
                    irAFragmentoDeLecciones()
                }
            }
    }
