...
class ResolverQuizAvanzadoFragment : Fragment() {
    ...
    private val quizzes = mutableListOf<QuizModelAvanzado>()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_resolver_quiz_avanzado, container, false)
    ...
    private fun loadQuizzes() {
        db.collection("quizzes_avanzado")
            .get()
            .addOnSuccessListener { querySnapshot ->
                quizzes.clear()
                for (document in querySnapshot.documents) {
                    val quiz = document.toObject(QuizModelAvanzado::class.java)
                    if (quiz != null) {
                        quizzes.add(quiz)
                    }
                }
