...
class ResolverQuizIntermedioFragment : Fragment() {
    ...
    private val quizzes = mutableListOf<QuizModelIntermedio>()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_resolver_quiz_intermedio, container, false)
    ...
    private fun loadQuizzes() {
        db.collection("quizzes_intermedio")
            .get()
            .addOnSuccessListener { querySnapshot ->
                quizzes.clear()
                for (document in querySnapshot.documents) {
                    val quiz = document.toObject(QuizModelIntermedio::class.java)
                    if (quiz != null) {
                        quizzes.add(quiz)
                    }
                }
...
// Modelo de datos
data class QuizModelIntermedio(
    val pregunta: String = "",
    val opcion1: String = "",
    val opcion2: String = "",
    val opcion3: String = "",
